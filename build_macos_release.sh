...
BUILD_VENV_DIR="${ROOT_DIR}/.venv-mac-build"
REQUIREMENTS_FILE="${ROOT_DIR}/requirements-macos-build.txt"
...
if [[ -z "${PYTHON_BIN}" ]]; then
  echo "Python 3.12 is required to build the macOS release." >&2
