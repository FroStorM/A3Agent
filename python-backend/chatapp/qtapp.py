...
# ── constants ─────────────────────────────────────────────────────────────────
HISTORY_FILE = os.path.join(str(data_dir()), "memory", "chat_history.json")
TEXT_FILE_EXTS = {
...
def _build_prompt_with_uploads(prompt: str, files: list) -> tuple:
    ...
    temp_uploaded = os.path.join(str(data_dir()), "temp", "uploaded")
...
class ChatPanel(QWidget):
    ...
    def _refresh_sop(self):
        ...
        memory_dir = os.path.join(str(data_dir()), "memory")
